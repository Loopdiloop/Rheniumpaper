...
// Cecilie, Aug 9, 2019
// Last update: edited for a specific dataset by Marianne 2021
...
void fits_CACTUS_peaks_protongate(){
    ...
    ofstream gainfile("cactus_gains_X.txt");

    // Grab input file
    TFile *file = TFile::Open("W186_a_p_doppler_ring4.root");
    ...
    banana_NaI00->RebinX(2);
    banana_NaI01->RebinX(2);
    banana_NaI02->RebinX(2);
    banana_NaI03->RebinX(2);
    banana_NaI04->RebinX(2);
    banana_NaI05->RebinX(2);
    banana_NaI06->RebinX(2);
    banana_NaI07->RebinX(2);
    banana_NaI08->RebinX(2);
    banana_NaI09->RebinX(2);
    banana_NaI10->RebinX(2);
    banana_NaI11->RebinX(2);
    banana_NaI12->RebinX(2);
    banana_NaI13->RebinX(2);
    banana_NaI14->RebinX(2);
    banana_NaI15->RebinX(2);
    banana_NaI16->RebinX(4);
    banana_NaI17->RebinX(2);
    banana_NaI18->RebinX(2);
    banana_NaI19->RebinX(4);
    banana_NaI20->RebinX(2);
    banana_NaI21->RebinX(2);
    banana_NaI22->RebinX(2);
    banana_NaI23->RebinX(2);
    banana_NaI24->RebinX(2);
    banana_NaI25->RebinX(2);
    banana_NaI26->RebinX(2);
    banana_NaI27->RebinX(4);
    banana_NaI28->RebinX(2);
    banana_NaI29->RebinX(4);

    // START THE FITS
    // Make canvas to plot the 2D banana plots, nai_00-nai_02
    TCanvas *c1 = new TCanvas("c1","c1: NaI peaks, nai_00-nai_02 ",2000,800);
    c1->Divide(3,2,0,0);
    c1->cd(1);
    gPad->SetLogz();
    ...
    TH1D *px00 = banana_NaI00->ProjectionX("px00",190,215);
    ...
    TH1D *px01 = banana_NaI01->ProjectionX("px01",190,215);
    ...
    TH1D *px02 = banana_NaI02->ProjectionX("px02",190,215);
   ...
   // Make canvas to plot the 2D banana plots, nai_03, nai_05, nai_06 (nai_04 is empty)
    TCanvas *c2 = new TCanvas("c2","c2: NaI peaks, nai_03, nai_05, nai_06 ",2000,800);
    c2->Divide(3,2,0,0);
    c2->cd(1);
    gPad->SetLogz();
    gPad->SetBottomMargin(0.13);
    ...
    TH1D *px03 = banana_NaI03->ProjectionX("px03",190,215);
    ...
    TH1D *px05 = banana_NaI05->ProjectionX("px05",190,215);
    ...
    TH1D *px06 = banana_NaI06->ProjectionX("px06",190,215);
   ...
   // Make canvas to plot the 2D banana plots, nai_07, nai_10, nai_11 (nai_08 and nai_09 are empty)
    TCanvas *c3 = new TCanvas("c3","c3: NaI peaks, nai_07, nai_10, nai_11 ",2000,800);
    c3->Divide(3,2,0,0);
    c3->cd(1);
    gPad->SetLogz();
    gPad->SetBottomMargin(0.13);
    ...
    TH1D *px07 = banana_NaI07->ProjectionX("px07",190,215);
    ...
    TH1D *px10 = banana_NaI10->ProjectionX("px10",190,215);
    ...
    TH1D *px11 = banana_NaI11->ProjectionX("px11",190,215);
   ...
   // Make canvas to plot the 2D banana plots, nai_13, nai_14, nai_15 (nai_12 is empty)
    TCanvas *c4 = new TCanvas("c4","c4: NaI peaks, nai_13, nai_14, nai_15 ",2000,800);
    c4->Divide(3,2,0,0);
    c4->cd(1);
    gPad->SetLogz();
    gPad->SetBottomMargin(0.13);
    ...
    TH1D *px13 = banana_NaI13->ProjectionX("px13",190,215);
    ...
    TH1D *px14 = banana_NaI14->ProjectionX("px14",190,215);
    ...
    TH1D *px15 = banana_NaI15->ProjectionX("px15",190,215);
    ...
    TCanvas *c5 = new TCanvas("c5","c5: NaI peaks, nai_16, nai_17, nai_18 ",2000,800);
    c5->Divide(3,2,0,0);
    c5->cd(1);
    gPad->SetLogz();
    gPad->SetBottomMargin(0.13);
    ...
    TH1D *px16 = banana_NaI16->ProjectionX("px16",190,215);
    ...
    TH1D *px17 = banana_NaI17->ProjectionX("px17",190,215);
    ...
    TH1D *px18 = banana_NaI18->ProjectionX("px18",190,215);
    ...
    TCanvas *c6 = new TCanvas("c6","c6: NaI peaks, nai_19, nai_20, nai_21 ",2000,800);
    c6->Divide(3,2,0,0);
    c6->cd(1);
    gPad->SetLogz();
    gPad->SetBottomMargin(0.13);
    ...
    TH1D *px19 = banana_NaI19->ProjectionX("px19",190,215);
    ...
    TH1D *px20 = banana_NaI20->ProjectionX("px20",190,215);
    ...
    TH1D *px21 = banana_NaI21->ProjectionX("px21",190,215);
    ...
    TCanvas *c7 = new TCanvas("c7","c7: NaI peaks, nai_22, nai_23, nai_24 ",2000,800);
    c7->Divide(3,2,0,0);
    c7->cd(1);
    gPad->SetLogz();
    gPad->SetBottomMargin(0.13);
    ...
    TH1D *px22 = banana_NaI22->ProjectionX("px22",190,215);
    ...
    TH1D *px23 = banana_NaI23->ProjectionX("px23",190,215);
    ...
    TH1D *px24 = banana_NaI24->ProjectionX("px24",190,215);
    ...
    TCanvas *c8 = new TCanvas("c8","c8: NaI peaks, nai_25, nai_26, nai_27 ",2000,800);
    c8->Divide(3,2,0,0);
    c8->cd(1);
    gPad->SetLogz();
    gPad->SetBottomMargin(0.13);
    ...
    TH1D *px25 = banana_NaI25->ProjectionX("px25",190,215);
    ...
    TH1D *px26 = banana_NaI26->ProjectionX("px26",190,215);
    ...
    TH1D *px27 = banana_NaI27->ProjectionX("px27",190,215);
    ...
    TCanvas *c9 = new TCanvas("c9","c9: NaI peaks, nai_28, nai_29 ",2000,800);
    c9->Divide(3,2,0,0);
    c9->cd(1);
    gPad->SetLogz();
    gPad->SetBottomMargin(0.13);
    ...
    TH1D *px28 = banana_NaI28->ProjectionX("px28",190,215);
    ...
    TH1D *px29 = banana_NaI29->ProjectionX("px29",190,215);
